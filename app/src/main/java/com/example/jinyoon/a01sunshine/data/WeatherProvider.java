...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        //NO_MATCH because we don't want the root path to match anything
        //This is typical
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                ...
                //BC this can only return a single row
            case WEATHER_WITH_LOCATION:
                return WeatherContract.WeatherEntry.CONTENT_TYPE;
                //BC this returns multiple items
            case WEATHER:
                return WeatherContract.WeatherEntry.CONTENT_TYPE;
            case LOCATION:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //this line will notify all registered observers
        return returnUri;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        //Notify only when row is delted
        if(rowDeleted!=0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
