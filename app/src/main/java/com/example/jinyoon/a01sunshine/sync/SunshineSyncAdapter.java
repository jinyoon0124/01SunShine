package com.example.jinyoon.a01sunshine.sync;
...
import com.example.jinyoon.a01sunshine.MainActivity;
import com.example.jinyoon.a01sunshine.R;
import com.example.jinyoon.a01sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    //This method is happening when a sync occurs.
    @Override
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(cursor.moveToFirst()){
            ...
            Uri intertedUri = this.getContext().getContentResolver().insert(
                    WeatherContract.LocationEntry.CONTENT_URI,
                    values
            );
